...
from myapp.views import group_details_ac
from myapp.views import group_marks_ac
from myapp.views import AChomeaction
from myapp.views import panel_members_details_ac
...
urlpatterns = [
    ...
    path('group_details_ac/', group_details_ac),
    path('group_marks_ac/', group_marks_ac),
    path('achomepage/', AChomeaction),
    path('panel.member.datail/', panel_members_details_ac)
